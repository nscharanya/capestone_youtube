...
client = pymongo.MongoClient("mongodb+srv://charanya_24:charanya@capestone-cluster.x4chbds.mongodb.net/?retryWrites=true&w=majority")
...
def channels_table():
    ...
    for index,row in df.iterrows():
        ...
        try:
            ...
            mydb.commit()
        except:("Channel values already inserted")
...
if st.button("Migrate to SQL"):
    Table = tables()       # Calls tables function
    st.success(Table)
